...
def arg_parser():
    ...
    parser.add_argument('--path_to_relation', default='', type=str,
                            help='relation path')

    # reweighing parameters
    parser.add_argument('--reweigh_n', type=int,  default=10, help='reweigh normalization')

    # imbalance parameters:

    parser.add_argument('--imbalanced', type=int,  default=0, help='Use Loss reweighting')
