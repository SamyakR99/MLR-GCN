...
def validate(data_loader, model, args):
    ...
    with torch.no_grad():
        ...
        for i,   ((images,segments), target) in enumerate(data_loader):
            ...
            for i in range(len(segments)):
                segments[i] = segments[i].to(device)
        ...
        torch.save(p_c, '/home/samyakr2/SHOP/DualCoOp/metric/p_c.pt')
        torch.save(r_c, '/home/samyakr2/SHOP/DualCoOp/metric/r_c.pt')
        torch.save(f_c, '/home/samyakr2/SHOP/DualCoOp/metric/f_c.pt')
        torch.save(p_o, '/home/samyakr2/SHOP/DualCoOp/metric/p_o.pt')
        torch.save(r_o, '/home/samyakr2/SHOP/DualCoOp/metric/r_o.pt')
        torch.save(f_o, '/home/samyakr2/SHOP/DualCoOp/metric/f_o.pt')
